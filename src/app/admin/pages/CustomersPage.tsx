...
function nextAppointment(customer: Customer, today: string) { return [...customer.appointments].filter((item) => item.date >= today).sort((a, b) => `${a.date}${a.time}`.localeCompare(`${b.date}${b.time}`))[0]; }
